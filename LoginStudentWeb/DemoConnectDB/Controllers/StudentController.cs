using AdvanceWeb.Areas.Identity.Data;
...
namespace AdvanceWeb.Controllers
{
    ...
    {
        private readonly AdvanceWebContext _context;
        private readonly IWebHostEnvironment _hostEnvironment;
        private object filename;

        public StudentController (AdvanceWebContext context,IWebHostEnvironment hostEnvironment){
            _context = context; 
